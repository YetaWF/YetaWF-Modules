...
public class BrowserNotificationsView : YetaWFView, IYetaWFView2<BrowserNotificationsModule, BrowserNotificationsModule.Model> {
    ...
    public async Task<string> RenderViewAsync(BrowserNotificationsModule module, BrowserNotificationsModule.Model model) {
...
{await RenderEndFormAsync()}");
    ...
    public async Task<string> RenderPartialViewAsync(BrowserNotificationsModule module, BrowserNotificationsModule.Model model) {
