...
public class SkinBrowserNotificationsModule : ModuleDefinition {
    ...
    public async Task<ActionInfo> RenderModuleAsync() {
        ...
        Manager.ScriptManager.AddLast($"{AreaRegistration.CurrentPackage.AreaName}_{ClassName}", $"new YetaWF_Messenger.SkinBrowserNotificationsModule('{Utility.JserEncode(ModuleHtmlId)}');");
