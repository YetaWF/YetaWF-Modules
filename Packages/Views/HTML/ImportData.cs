...
public class ImportDataView : YetaWFView, IYetaWFView<ImportDataModule, ImportDataModule.ImportDataModel> {
    ...
    public async Task<string> RenderViewAsync(ImportDataModule module, ImportDataModule.ImportDataModel model) {
