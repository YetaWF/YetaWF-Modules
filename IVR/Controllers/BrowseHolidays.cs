...
namespace Softelvdm.Modules.IVR.Controllers {
    ...
    public class BrowseHolidaysModuleController : ControllerImpl<Softelvdm.Modules.IVR.Modules.BrowseHolidaysModule> {
        ...
        public async Task<ActionResult> BrowseHolidays_GridData(string fieldPrefix, int skip, int take, List<DataProviderSortInfo> sorts, List<DataProviderFilterInfo> filters) {
