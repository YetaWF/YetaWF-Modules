...
namespace Softelvdm.Modules.IVR.Controllers {
    ...
    public class BrowseVoiceMailsModuleController : ControllerImpl<Softelvdm.Modules.IVR.Modules.BrowseVoiceMailsModule> {
        ...
        public async Task<ActionResult> BrowseVoiceMails_GridData(string fieldPrefix, int skip, int take, List<DataProviderSortInfo> sorts, List<DataProviderFilterInfo> filters) {
            Manager.NeedUser();
