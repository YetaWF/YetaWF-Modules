...
namespace Softelvdm.Modules.IVR.Controllers {
    ...
    public class BrowseExtensionsModuleController : ControllerImpl<Softelvdm.Modules.IVR.Modules.BrowseExtensionsModule> {
        ...
        public async Task<ActionResult> BrowseExtensions_GridData(string fieldPrefix, int skip, int take, List<DataProviderSortInfo> sorts, List<DataProviderFilterInfo> filters) {
