...
#if MVC6
        public static async Task<HtmlString> RenderListOfLocalPagesAddNewAsync<TModel>(this IHtmlHelper<TModel> htmlHelper, string name, List<string> model)
#else
        public static async Task<HtmlString> RenderListOfLocalPagesAddNewAsync<TModel>(this HtmlHelper<TModel> htmlHelper, string name, List<string> model)
#endif
        {
