...
public class EditView : YetaWFView, IYetaWFView<SkinPaletteModule, SkinPaletteModule.Model> {
    ...
    public async Task<string> RenderViewAsync(SkinPaletteModule module, SkinPaletteModule.Model model) {
...
<div class='t_contents' style='display:none'>
    ...
    private List<Entry> GetLookupTable(SkinPaletteModule.Model model) {
