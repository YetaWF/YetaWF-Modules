...
namespace YetaWF_SkinPalette {
    ...
    export class SkinPaletteModule extends YetaWF.ModuleBaseDataImpl {
        ...
        private generateSkin(): void {
            ...
            this.getColor("TabsTabBgFocus").value = values.GenTheme === BasicThemeEnum.Light ? this.Darken(values.GenBgShadedActive, 40) : this.Lighten(values.GenBgShadedActive, 20);
            this.getColor("TabsTabClrFocus").value = values.GenTheme === BasicThemeEnum.Light ? this.Darken(values.GenClrShadedActive, 40) : this.Lighten(values.GenClrShadedActive, 20);
