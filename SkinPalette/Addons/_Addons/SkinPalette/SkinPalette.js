...
(function (YetaWF_SkinPalette) {
    ...
    var SkinPaletteModule = /** @class */ (function (_super) {
        ...
        SkinPaletteModule.prototype.generateSkin = function () {
            ...
            this.getInput("DialogTitleBorder").value = "".concat(values.GenBorderWidth, "px solid ").concat(values.GenBorderClr);
            this.getInput("DialogTitleBorderRadius").value = "".concat(values.GenBorderRadius, "px");
            this.getInput("DialogLine").value = "".concat(values.GenBorderWidth, "px solid ").concat(values.GenBorderClr);
