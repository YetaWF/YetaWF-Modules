...
(function (YetaWF_SkinPalette) {
    ...
    var SkinPaletteModule = /** @class */ (function (_super) {
        ...
        SkinPaletteModule.prototype.generateSkin = function () {
            ...
            this.getInput("MainMenu0BorderRadius").value = "".concat(values.GenBorderRadius, "px");
            ...
            this.getInput("MainMenu1Border").value = "".concat(values.GenBorderWidth, "px solid ").concat(values.GenBorderClr);
            this.getInput("MainMenu1BorderRadius").value = "".concat(values.GenBorderRadius, "px");
            ...
            this.getInput("MainMenu2Border").value = "".concat(values.GenBorderWidth, "px solid ").concat(values.GenBorderClr);
            this.getInput("MainMenu2BorderRadius").value = "".concat(values.GenBorderRadius, "px");
            ...
            this.getInput("MainMenuSVGSmallBorder").value = "".concat(values.GenBorderWidth, "px solid ").concat(values.GenBorderClr);
            this.getInput("MainMenuSVGSmallBorderRadius").value = "".concat(values.GenBorderRadius, "px");
