...
(function (YetaWF_CurrencyConverter) {
    ...
    $YetaWF.registerEventHandlerDocument("click", ".YetaWF_CurrencyConverter_CurrencyConverter input[name='convert']", function (ev) {
        ...
        var result_from = $YetaWF.getElement1BySelector(".t_result_from", [divConverter]);
        var result_to = $YetaWF.getElement1BySelector(".t_result_to", [divConverter]);
        var result_is = $YetaWF.getElement1BySelector(".t_result_is", [divConverter]);
