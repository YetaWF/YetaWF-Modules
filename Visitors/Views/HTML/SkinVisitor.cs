...
public class SkinVisitorView : YetaWFView, IYetaWFView2<SkinVisitorModule, SkinVisitorModule.DisplayModel> {
    ...
    public async Task<string> RenderViewAsync(SkinVisitorModule module, SkinVisitorModule.DisplayModel model) {
...
{await RenderEndFormAsync()}");
    ...
    public Task<string> RenderPartialViewAsync(SkinVisitorModule module, SkinVisitorModule.DisplayModel model) {
