...
namespace YetaWF.Modules.DevTests.Views {
    ...
    public class TemplateScrollerView : YetaWFView, IYetaWFView<TemplateScrollerModule, TemplateScrollerModule.Model> {
        ...
        public async Task<string> RenderViewAsync(TemplateScrollerModule module, TemplateScrollerModule.Model model) {
