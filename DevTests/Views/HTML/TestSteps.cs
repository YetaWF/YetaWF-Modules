...
namespace YetaWF.Modules.DevTests.Views {
    ...
    public class TestStepsView : YetaWFView, IYetaWFView<TestStepsModule, TestStepsModule.Model> {
        ...
        public async Task<string> RenderViewAsync(TestStepsModule module, TestStepsModule.Model model) {
