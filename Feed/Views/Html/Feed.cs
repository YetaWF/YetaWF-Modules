...
public class FeedView : YetaWFView, IYetaWFView<FeedModule, FeedModule.DisplayModel> {
    ...
    public async Task<string> RenderViewAsync(FeedModule module, FeedModule.DisplayModel model) {
...
<div id='{DivId}' class='t_news'>
    ...
    <div class='t_headerentry'></div>");
        ...
        foreach (FeedModule.Entry entry in model.Entries) {
            string? author = null;
            foreach (FeedModule.Author a in entry.Authors) {
