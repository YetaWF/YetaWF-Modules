...
public class SitePropertiesView : YetaWFView, IYetaWFView2<SitePropertiesModule, SitePropertiesModule.SitePropertiesModel> {
    ...
    public async Task<string> RenderViewAsync(SitePropertiesModule module, SitePropertiesModule.SitePropertiesModel model) {
...
{await RenderEndFormAsync()}");
    ...
    public async Task<string> RenderPartialViewAsync(SitePropertiesModule module, SitePropertiesModule.SitePropertiesModel model) {
