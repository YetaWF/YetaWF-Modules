...
public class LocalizeBrowsePackageModule : ModuleDefinition2 {
        ...
        return new GridDefinition {
            ...
            DirectDataAsync = async (int skip, int take, List<DataProviderSortInfo>? sort, List<DataProviderFilterInfo>? filters) => {
                ...
                return new DataSourceResult {
                    Data = (from s in recs.Data select new BrowseItem(this, package.Name, s.FileName)).ToList<object>(),
                    Total = recs.Total
                };
            },
        };
    ...
    public async Task<ActionInfo> RenderModuleAsync(string packageName) {
        ...
        Title = this.__ResStr("title", "Localization Resources - Package {0}", package.Name);
