...
public class LocalizeBrowsePackageView : YetaWFView, IYetaWFView2<LocalizeBrowsePackageModule, LocalizeBrowsePackageModule.BrowseModel> {
    ...
    public async Task<string> RenderViewAsync(LocalizeBrowsePackageModule module, LocalizeBrowsePackageModule.BrowseModel model) {
...
{await RenderEndFormAsync()}");
    ...
    public Task<string> RenderPartialViewAsync(LocalizeBrowsePackageModule module, LocalizeBrowsePackageModule.BrowseModel model) {
