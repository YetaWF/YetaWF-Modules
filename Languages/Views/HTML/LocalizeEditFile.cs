...
public class LocalizeEditFileView : YetaWFView, IYetaWFView2<LocalizeEditFileModule, LocalizeEditFileModule.EditModel> {
    ...
    public async Task<string> RenderViewAsync(LocalizeEditFileModule module, LocalizeEditFileModule.EditModel model) {
...
{await RenderEndFormAsync()}");
    ...
    public async Task<string> RenderPartialViewAsync(LocalizeEditFileModule module, LocalizeEditFileModule.EditModel model) {
