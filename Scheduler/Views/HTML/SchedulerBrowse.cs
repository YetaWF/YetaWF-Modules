...
public class SchedulerBrowseView : YetaWFView, IYetaWFView2<SchedulerBrowseModule, SchedulerBrowseModule.SchedulerBrowseModel> {
    ...
    public async Task<string> RenderViewAsync(SchedulerBrowseModule module, SchedulerBrowseModule.SchedulerBrowseModel model) {
...
{await RenderEndFormAsync()}");
    ...
    public async Task<string> RenderPartialViewAsync(SchedulerBrowseModule module, SchedulerBrowseModule.SchedulerBrowseModel model) {
