...
public class LogBrowseView : YetaWFView, IYetaWFView2<LogBrowseModule, LogBrowseModule.BrowseModel> {
    ...
    public async Task<string> RenderViewAsync(LogBrowseModule module, LogBrowseModule.BrowseModel model) {
...
<div class='{Globals.CssDivWarning} t_browselog t_file'>
    ...
    public async Task<string> RenderPartialViewAsync(LogBrowseModule module, LogBrowseModule.BrowseModel model) {
