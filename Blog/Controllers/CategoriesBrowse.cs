...
namespace YetaWF.Modules.Blog.Controllers {
    ...
    public class CategoriesBrowseModuleController : ControllerImpl<YetaWF.Modules.Blog.Modules.CategoriesBrowseModule> {
        ...
        public async Task<ActionResult> CategoriesBrowse_GridData(string fieldPrefix, int skip, int take, List<DataProviderSortInfo> sorts, List<DataProviderFilterInfo> filters) {
