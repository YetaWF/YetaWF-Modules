...
namespace YetaWF.Modules.ComponentsHTML.Components {
    ...
    /// <summary>
    /// Base class for the TimeSpanHM component implementation.
    /// </summary>
    public abstract class TimeSpanHMComponentBase : YetaWFComponent {

        internal const string TemplateName = "TimeSpanHM";
    ...
    public class TimeSpanHMEditComponent : TimeSpanHMComponentBase, IYetaWFComponent<TimeSpan>, IYetaWFComponent<TimeSpan?> {
        ...
        public override async Task IncludeAsync() {
            await Manager.AddOnManager.AddTemplateAsync(Controllers.AreaRegistration.CurrentPackage.AreaName, "TimeSpan", ComponentType.Edit);
