...
namespace YetaWF.Modules.ComponentsHTML.Components {
    ...
    /// <summary>
    /// Base class for the CAProvince component implementation.
    /// </summary>
    public abstract class CAProvinceComponentBase : YetaWFComponent {

        internal static string __ResStr(string name, string defaultValue, params object[] parms) { return ResourceAccess.GetResourceString(typeof(CAProvinceComponentBase), name, defaultValue, parms); }

        internal const string TemplateName = "CAProvince";
