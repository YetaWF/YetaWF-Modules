...
namespace YetaWF.Modules.ComponentsHTML.Components {
    ...
    public abstract class BooleanComponent : YetaWFComponent {

        public const string TemplateName = "Boolean";

        public override Package GetPackage() { return Controllers.AreaRegistration.CurrentPackage; }
        public override string GetTemplateName() { return TemplateName; }
    }

    public class BooleanDisplayComponent : BooleanComponent, IYetaWFComponent<bool?> {
    ...
    public class BooleanEditComponent : BooleanComponent, IYetaWFComponent<bool>, IYetaWFComponent<bool?> {
