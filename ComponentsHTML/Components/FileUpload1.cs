...
namespace YetaWF.Modules.ComponentsHTML.Components {
    ...
    ///     SaveURL = YetaWFManager.UrlFor(typeof(PageControlModuleEndpoints), nameof(PageControlModuleEndpoints.ImportPackage)),
    ///     RemoveURL = YetaWFManager.UrlFor(typeof(PageControlModuleEndpoints), nameof(PageControlModuleEndpoints.RemovePackage)),
    ///     SerializeForm = true,
    /// };
    /// </example>
