...
namespace YetaWF.Modules.ComponentsHTML.Views {
    ...
    /// <summary>
    /// Implements a standard PropertyListEdit view.
    /// </summary>
    /// <remarks>The model is rendered using the PropertyList edit component.</remarks>
    public class PropertyListEditView : YetaWFView, IYetaWFView2<ModuleDefinition, object> {

        internal const string ViewName = ModuleDefinition.StandardViews.PropertyListEdit;
