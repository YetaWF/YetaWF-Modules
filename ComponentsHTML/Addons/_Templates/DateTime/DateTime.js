...
(function (YetaWF_ComponentsHTML) {
    var DateTime = /** @class */ (function () {
        ...
        DateTime.prototype.getGrid = function (ctrlId) {
            var el = document.getElementById(ctrlId);
            if (el == null)
                throw "Grid element " + ctrlId + " not found"; /*DEBUG*/
            return el;
        };
        DateTime.prototype.getControl = function (ctrlId) {
            var el = document.getElementById(ctrlId);
            if (el == null)
                throw "Element " + ctrlId + " not found"; /*DEBUG*/
            return el;
        };
        DateTime.prototype.getHidden = function (ctrl) {
            var hidden = ctrl.querySelector("input[type=\"hidden\"]");
            if (hidden == null)
                throw "Couldn't find hidden field"; /*DEBUG*/
            return hidden;
        };
        DateTime.prototype.setHidden = function (hidden, dateVal) {
            var s = "";
            if (dateVal != null) {
        ...
        DateTime.prototype.setHiddenText = function (hidden, dateVal) {
            hidden.setAttribute("value", dateVal ? dateVal : "");
        };
        DateTime.prototype.getDate = function (ctrl) {
         ...
         */
        DateTime.prototype.init = function (ctrlId) {
            var thisObj = this;
         ...
         */
        DateTime.prototype.renderjqGridFilter = function (gridId, elem) {
    ...
    YetaWF_ComponentsHTML.DateTime = DateTime;
