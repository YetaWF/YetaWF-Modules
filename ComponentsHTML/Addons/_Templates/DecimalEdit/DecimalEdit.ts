...
namespace YetaWF_ComponentsHTML {
    ...
    export class DecimalEditComponent extends NumberEditComponentBase {

        public static readonly TEMPLATE: string = "yt_decimal";
        public static readonly SELECTOR: string = ".yt_decimal.t_edit";
        ...
        constructor(controlId: string, setup: NumberSetup) {
            super(controlId, setup, DecimalEditComponent.TEMPLATE, DecimalEditComponent.SELECTOR);
        }
    }
}
