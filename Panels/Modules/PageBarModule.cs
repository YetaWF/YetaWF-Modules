...
namespace YetaWF.Modules.Panels.Modules {
    ...
    public class PageBarModule : ModuleDefinition {
        ...
        public PageBarModule() {
            ...
            Description = this.__ResStr("modSummary", "Page Bar - used to display multiple links to pages using the pages' FavIcon, displaying the page contents within the PageBar module");
