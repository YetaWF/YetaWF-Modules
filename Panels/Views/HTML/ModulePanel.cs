...
public class ModulePanelView : YetaWFView, IYetaWFView2<ModulePanelModule, ModulePanelModule.Model> {
    ...
    public async Task<string> RenderViewAsync(ModulePanelModule module, ModulePanelModule.Model model) {
...
{await HtmlHelper.ForDisplayAsync(model, nameof(model.PanelInfo))}");
    ...
    public async Task<string> RenderPartialViewAsync(ModulePanelModule module, ModulePanelModule.Model model) {
