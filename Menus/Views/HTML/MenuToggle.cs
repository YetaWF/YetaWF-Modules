...
public class MenuToggleView : YetaWFView, IYetaWFView<MenuToggleModule, MenuToggleModule.Model> {
    ...
    public async Task<string> RenderViewAsync(MenuToggleModule module, MenuToggleModule.Model model) {
