...
public class SearchResultsView : YetaWFView, IYetaWFView<SearchResultsModule, SearchResultsModule.Model> {
    ...
    public async Task<string> RenderViewAsync(SearchResultsModule module, SearchResultsModule.Model model) {
