...
namespace YetaWF.Modules.Search.Controllers {
    ...
    public class SearchBrowseModuleController : ControllerImpl<YetaWF.Modules.Search.Modules.SearchBrowseModule> {
        ...
        public async Task<ActionResult> SearchBrowse_GridData(string fieldPrefix, int skip, int take, List<DataProviderSortInfo> sorts, List<DataProviderFilterInfo> filters) {
