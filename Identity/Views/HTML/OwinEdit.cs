...
public class OwinEditView : YetaWFView, IYetaWFView2<OwinEditModule, OwinEditModule.EditModel> {
    ...
    public async Task<string> RenderViewAsync(OwinEditModule module, OwinEditModule.EditModel model) {
...
{await RenderEndFormAsync()}");
    ...
    public async Task<string> RenderPartialViewAsync(OwinEditModule module, OwinEditModule.EditModel model) {
