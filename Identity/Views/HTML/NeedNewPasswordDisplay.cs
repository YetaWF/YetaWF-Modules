...
public class NeedNewPasswordDisplayView : YetaWFView, IYetaWFView<NeedNewPasswordDisplayModule, NeedNewPasswordDisplayModule.DisplayModel> {
    ...
    public async Task<string> RenderViewAsync(NeedNewPasswordDisplayModule module, NeedNewPasswordDisplayModule.DisplayModel model) {
