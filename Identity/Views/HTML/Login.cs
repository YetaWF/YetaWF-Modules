...
public class LoginView : YetaWFView, IYetaWFView2<LoginModule, LoginModule.LoginModel> {
    ...
    public async Task<string> RenderViewAsync(LoginModule module, LoginModule.LoginModel model) {
...
<div class='t_external'>
    ...
    public async Task<string> RenderPartialViewAsync(LoginModule module, LoginModule.LoginModel model) {
