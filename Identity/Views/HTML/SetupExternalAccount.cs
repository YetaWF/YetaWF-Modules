...
public class SetupExternalAccountView : YetaWFView, IYetaWFView2<SetupExternalAccountModule, SetupExternalAccountModule.SetupExternalAccountModel> {
    ...
    public async Task<string> RenderViewAsync(SetupExternalAccountModule module, SetupExternalAccountModule.SetupExternalAccountModel model) {
...
{await RenderEndFormAsync()}");
    ...
    public async Task<string> RenderPartialViewAsync(SetupExternalAccountModule module, SetupExternalAccountModule.SetupExternalAccountModel model) {
