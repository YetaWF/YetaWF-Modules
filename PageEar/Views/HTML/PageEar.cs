...
public class EditView : YetaWFView, IYetaWFView<PageEarModule, PageEarModule.Model> {
    ...
    public async Task<string> RenderViewAsync(PageEarModule module, PageEarModule.Model model) {
