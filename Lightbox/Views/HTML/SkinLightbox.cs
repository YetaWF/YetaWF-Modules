...
public class SkinLightboxView : YetaWFView, IYetaWFView<SkinLightboxModule, SkinLightboxModule.Model> {
    ...
    public Task<string> RenderViewAsync(SkinLightboxModule module, SkinLightboxModule.Model model) {
