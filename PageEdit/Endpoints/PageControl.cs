...
using static YetaWF.Modules.PageEdit.Controllers.PageControlModuleController;
    ...
    public class PageControlModuleEndpoints : YetaWFEndpoints {
        ...
        public static void RegisterEndpoints(IEndpointRouteBuilder endpoints, Package package, string areaName) {
            ...
            group.MapPost(ImportModule, async (HttpContext context, Guid __ModuleGuid, IFormFile __filename, 
                    [FromQuery] Guid currentPageGuid, [FromQuery] string modulePane, [FromQuery] Location moduleLocation) => {
                ModuleDefinition module = await GetModuleAsync(__ModuleGuid);
                if (!module.IsAuthorized()) return Results.Unauthorized();
                ...
                bool success = await ModuleDefinition.ImportAsync(tempName, currentPageGuid, true, modulePane, moduleLocation == Location.Top, errorList);
