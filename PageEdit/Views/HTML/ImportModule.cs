...
namespace YetaWF.Modules.PageEdit.Views {
    ...
    public class ImportModuleView : YetaWFView, IYetaWFView2<PageControlModule, PageControlModuleController.ImportModuleModel> {
        ...
        public async Task<YHtmlString> RenderViewAsync(PageControlModule module, PageControlModuleController.ImportModuleModel model) {
        ...
        public async Task<YHtmlString> RenderPartialViewAsync(PageControlModule module, PageControlModuleController.ImportModuleModel model) {
            HtmlBuilder hb = new HtmlBuilder();
