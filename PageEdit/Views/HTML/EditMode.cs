...
public class EditModeView : YetaWFView, IYetaWFView<EditModeModule, EditModeModule.Model> {
    ...
    public Task<string> RenderViewAsync(EditModeModule module, EditModeModule.Model model) {
