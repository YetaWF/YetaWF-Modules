...
namespace YetaWF.Modules.PageEdit.Views {
    ...
    public class AddNewPageView : YetaWFView, IYetaWFView2<PageControlModule, PageControlModuleController.AddNewPageModel> {
        ...
        public async Task<YHtmlString> RenderViewAsync(PageControlModule module, PageControlModuleController.AddNewPageModel model) {
        ...
        public async Task<YHtmlString> RenderPartialViewAsync(PageControlModule module, PageControlModuleController.AddNewPageModel model) {
            HtmlBuilder hb = new HtmlBuilder();
