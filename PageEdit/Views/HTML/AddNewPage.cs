...
public class AddNewPageView : YetaWFView, IYetaWFView2<PageControlModule, PageControlModule.AddNewPageModel> {
    ...
    public async Task<string> RenderViewAsync(PageControlModule module, PageControlModule.AddNewPageModel model) {
    ...
    public async Task<string> RenderPartialViewAsync(PageControlModule module, PageControlModule.AddNewPageModel model) {
        HtmlBuilder hb = new HtmlBuilder();
