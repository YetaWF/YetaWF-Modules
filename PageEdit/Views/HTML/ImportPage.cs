...
namespace YetaWF.Modules.PageEdit.Views {
    ...
    public class ImportPageView : YetaWFView, IYetaWFView2<PageControlModule, PageControlModuleController.ImportPageModel> {
        ...
        public async Task<string> RenderViewAsync(PageControlModule module, PageControlModuleController.ImportPageModel model) {
        ...
        public async Task<string> RenderPartialViewAsync(PageControlModule module, PageControlModuleController.ImportPageModel model) {
            HtmlBuilder hb = new HtmlBuilder();
