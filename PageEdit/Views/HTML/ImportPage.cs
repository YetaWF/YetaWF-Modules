...
public class ImportPageView : YetaWFView, IYetaWFView2<PageControlModule, PageControlModule.ImportPageModel> {
    ...
    public async Task<string> RenderViewAsync(PageControlModule module, PageControlModule.ImportPageModel model) {
    ...
    public async Task<string> RenderPartialViewAsync(PageControlModule module, PageControlModule.ImportPageModel model) {
        HtmlBuilder hb = new HtmlBuilder();
