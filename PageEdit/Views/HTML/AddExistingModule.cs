...
namespace YetaWF.Modules.PageEdit.Views {
    ...
    public class AddExistingModuleView : YetaWFView, IYetaWFView2<PageControlModule, PageControlModuleController.AddExistingModel> {
        ...
        public async Task<YHtmlString> RenderViewAsync(PageControlModule module, PageControlModuleController.AddExistingModel model) {
        ...
        public async Task<YHtmlString> RenderPartialViewAsync(PageControlModule module, PageControlModuleController.AddExistingModel model) {
            HtmlBuilder hb = new HtmlBuilder();
