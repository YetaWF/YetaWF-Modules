...
namespace YetaWF.Modules.PageEdit.Views {
    ...
    public class AddNewModuleView : YetaWFView, IYetaWFView2<PageControlModule, PageControlModuleController.AddNewModuleModel> {
        ...
        public async Task<YHtmlString> RenderViewAsync(PageControlModule module, PageControlModuleController.AddNewModuleModel model) {
        ...
        public async Task<YHtmlString> RenderPartialViewAsync(PageControlModule module, PageControlModuleController.AddNewModuleModel model) {
            HtmlBuilder hb = new HtmlBuilder();
