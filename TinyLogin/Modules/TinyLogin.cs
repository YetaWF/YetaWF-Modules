...
public class TinyLoginModule : ModuleDefinition {
    ...
    public async Task<ActionInfo> RenderModuleAsync() {
        TinyLoginModel model = new TinyLoginModel {
            ...
            LogonUrl = string.IsNullOrWhiteSpace(LogonUrl) ? Manager.CurrentSite.LoginUrl : LogonUrl,
            LogoffUrl = string.IsNullOrWhiteSpace(LogoffUrl) ? Manager.CurrentSite.HomePageUrl : LogoffUrl,
            RegisterUrl = string.IsNullOrWhiteSpace(RegisterUrl) ? Manager.CurrentSite.LoginUrl : RegisterUrl,
