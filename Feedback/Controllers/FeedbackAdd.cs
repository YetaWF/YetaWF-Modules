/* Copyright © 2022 Softel vdm, Inc. - https://yetawf.com/Documentation/YetaWF/Feedback#License */
    ...
    public class FeedbackAddModuleController : ControllerImpl<YetaWF.Modules.Feedback.Modules.FeedbackAddModule> {
        ...
        public async Task<ActionResult> FeedbackAdd() {
            AddModel model = new AddModel {
                Captcha = new RecaptchaV2Data(),
                Subject = Module.DefaultSubject ?? string.Empty,
                Message = Module.DefaultMessage ?? string.Empty,
            };
