...
namespace YetaWF.Modules.Feedback.Controllers {
    ...
    public class FeedbackBrowseModuleController : ControllerImpl<YetaWF.Modules.Feedback.Modules.FeedbackBrowseModule> {
        ...
        public async Task<ActionResult> FeedbackBrowse_GridData(string fieldPrefix, int skip, int take, List<DataProviderSortInfo> sorts, List<DataProviderFilterInfo> filters) {
