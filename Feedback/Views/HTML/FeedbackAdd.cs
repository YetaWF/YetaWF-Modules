...
public class FeedbackAddView : YetaWFView, IYetaWFView2<FeedbackAddModule, FeedbackAddModule.AddModel> {
    ...
    public async Task<string> RenderViewAsync(FeedbackAddModule module, FeedbackAddModule.AddModel model) {
...
{await RenderEndFormAsync()}");
    ...
    public async Task<string> RenderPartialViewAsync(FeedbackAddModule module, FeedbackAddModule.AddModel model) {
