...
public class DisposableTrackerBrowseView : YetaWFView, IYetaWFView2<DisposableTrackerBrowseModule, DisposableTrackerBrowseModule.BrowseModel> {
    ...
    public async Task<string> RenderViewAsync(DisposableTrackerBrowseModule module, DisposableTrackerBrowseModule.BrowseModel model) {
...
{await RenderEndFormAsync()}");
    ...
    public async Task<string> RenderPartialViewAsync(DisposableTrackerBrowseModule module, DisposableTrackerBrowseModule.BrowseModel model) {
