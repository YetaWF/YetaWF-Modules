...
public class StaticPagesBrowseView : YetaWFView, IYetaWFView2<StaticPagesBrowseModule, StaticPagesBrowseModule.BrowseModel> {
    ...
    public async Task<string> RenderViewAsync(StaticPagesBrowseModule module, StaticPagesBrowseModule.BrowseModel model) {
...
{await RenderEndFormAsync()}");
    ...
    public async Task<string> RenderPartialViewAsync(StaticPagesBrowseModule module, StaticPagesBrowseModule.BrowseModel model) {
