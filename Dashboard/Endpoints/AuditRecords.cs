...
namespace YetaWF.Modules.Dashboard.Endpoints {
    ...
    public class AuditRecordsModuleEndpoints : YetaWFEndpoints {
        ...
        public static void RegisterEndpoints(IEndpointRouteBuilder endpoints, Package package, string areaName) {
            ...
            RouteGroupBuilder group = endpoints.MapGroup(GetPackageRoute(package, typeof(AuditRecordsModuleEndpoints)))
            ...
            group.MapPost(GridSupport.BrowseGridData, async (HttpContext context, [FromBody] GridSupport.GridPartialViewData gridPvData) => {
                ...
                return await GridSupport.GetGridPartialAsync(context, module, AuditRecordsModuleController.GetGridModel(module), gridPvData);
            });
