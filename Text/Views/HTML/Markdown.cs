...
namespace YetaWF.Modules.Text.Views {
    ...
    public class MarkdownView : YetaWFView, IYetaWFView2<MarkdownModule, MarkdownModuleController.ModelEdit> {

        public const string ViewName = "Markdown";

        public override Package GetPackage() { return AreaRegistration.CurrentPackage; }
        public override string GetViewName() { return ViewName; }

        public async Task<string> RenderViewAsync(MarkdownModule module, MarkdownModuleController.ModelEdit model) {
...
{await RenderEndFormAsync()}");
        ...
        public Task<string> RenderPartialViewAsync(MarkdownModule module, MarkdownModuleController.ModelEdit model) {
