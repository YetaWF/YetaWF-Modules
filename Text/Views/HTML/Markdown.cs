...
public class MarkdownView : YetaWFView, IYetaWFView2<MarkdownModule, MarkdownModule.ModelEdit> {
    ...
    public async Task<string> RenderViewAsync(MarkdownModule module, MarkdownModule.ModelEdit model) {
...
{await RenderEndFormAsync()}");
    ...
    public Task<string> RenderPartialViewAsync(MarkdownModule module, MarkdownModule.ModelEdit model) {
