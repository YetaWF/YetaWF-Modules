...
public class TextView : YetaWFView, IYetaWFView2<TextModule, TextModule.TextModel> {
    ...
    public async Task<string> RenderViewAsync(TextModule module, TextModule.TextModel model) {
...
{await RenderEndFormAsync()}");
    ...
    public Task<string> RenderPartialViewAsync(TextModule module, TextModule.TextModel model) {
